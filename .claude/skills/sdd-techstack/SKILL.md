...
Decide the tech stack and record it in `specs/tech-stack.md`. The product description
(`specs/briefing.md` + reconciled epics) is the **source of truth** — every technical choice
...
4. **Record it.** Copy `specs/_templates/tech-stack.md` to `specs/tech-stack.md` and fill the
