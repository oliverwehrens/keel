...
1. **Tests run green.** Actually execute the suite (per `${CLAUDE_PROJECT_DIR}/specs/tech-stack.md` testing). If you
...
5. **Definition of Done.** Walk the story's DoD checklist (see `${CLAUDE_PLUGIN_ROOT}/CONVENTIONS.md`). Each item is
