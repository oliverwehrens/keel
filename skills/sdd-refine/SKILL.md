...
`${CLAUDE_PLUGIN_ROOT}/CONVENTIONS.md` — especially the **confidence gate** — before starting.

## Input

The target epic. If the user didn't name one, list epics in `${CLAUDE_PROJECT_DIR}/specs/epics/` with their
